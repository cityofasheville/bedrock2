...
# Configure Terragrunt to automatically store tfstate files in an S3 bucket for all config in this repo
remote_state {
  backend = "s3"
  config = {
    encrypt = true
    # You may want to change this bucket name to suit your needs
