insert into internal.pr_employee_info (emp_id, active, employee, emp_email, ft_status, "position", dept_id, department, div_id, division, sup_id, supervisor, sup_email, hire_date_last)
values (
