  ...
  for (let file_name of file_names) {
    ...
    if (fileNm[fileNm.length - 1].toLowerCase() === 'csv')  {
      ...
      if (fileContent.length > 0) {
        ...
        // load into DB
        let sql = `insert into bedrock.${tableName} values (`;
      ...
      for (let f of file_list) {
        ...
        if (fileNm[fileNm.length - 2].toLowerCase() === 'etl')  {
          // ETL files
            ...
            let sql = `insert into bedrock.etl(asset_id, run_group_id, active) values ($1,$2,$3);`;
          ...
          // console.log(asset);
          let sql = `insert into bedrock.assets
          ...
          for (let tag of asset.tags) {
            sql = `insert into bedrock.asset_tags(asset_id, tag_id) values ($1,$2);`;
